# Manual Setup Steps for Minions Test-targets
...
Go to **GitHub → mxn2020/minions-test-targets → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-test-targets` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-test-targets-web`
- **GitHub repo**: `mxn2020/minions-test-targets`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `test-targets.minions.wtf`

### Documentation
- **Netlify site name**: `minions-test-targets-docs`
- **GitHub repo**: `mxn2020/minions-test-targets`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `test-targets.minions.help`

### Blog
- **Netlify site name**: `minions-test-targets-blog`
- **GitHub repo**: `mxn2020/minions-test-targets`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `test-targets.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `test-targets.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `test-targets.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `test-targets.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-test-targets/sdk`](https://www.npmjs.com/package/@minions-test-targets/sdk)
- CLI: [`@minions-test-targets/cli`](https://www.npmjs.com/package/@minions-test-targets/cli)
...
Your package: [`minions-test-targets`](https://pypi.org/project/minions-test-targets/)
...
| Item | Value |
|------|-------|
| Project | `minions-test-targets` |
| SDK (npm) | `@minions-test-targets/sdk` |
| CLI (npm) | `@minions-test-targets/cli` |
| Python (PyPI) | `minions-test-targets` |
| GitHub | `github.com/mxn2020/minions-test-targets` |
| Docs domain | `test-targets.minions.help` |
| Blog domain | `test-targets.minions.blog` |
| App domain | `test-targets.minions.wtf` |
