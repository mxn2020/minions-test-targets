...
- `@minions-test-targets/sdk` (npm package)
- `minions-test-targets` (PyPI package)
- `@minions-test-targets/cli` (npm package)
- The minions-test-targets web playground
- The minions-test-targets documentation site
