...
/**
 * @minions-test-targets/cli — CLI for Minions Test-targets
 *
...
import { customTypes } from '@minions-test-targets/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Test-targets'));
        console.log(chalk.dim('Agent-under-test definitions, endpoints, capabilities, and auth configs'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-test-targets/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-test-targets/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-test-targets')}`);
